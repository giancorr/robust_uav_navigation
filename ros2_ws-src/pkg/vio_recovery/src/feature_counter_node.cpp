...
public:
    FeatureCounterNode() : Node("feature_counter_node"),
        ...
        feature_pub_ = this->create_publisher<vio_recovery::msg::FeatureCount>(
...
private:
    ...
    void publish_totals() {
        auto pub_msg = vio_recovery::msg::FeatureCount();
    ...
    rclcpp::Publisher<vio_recovery::msg::FeatureCount>::SharedPtr feature_pub_;
};
