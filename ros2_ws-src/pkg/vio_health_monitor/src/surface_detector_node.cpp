...
public:
    SurfaceDetector() : Node("surface_detector_node") {
        ...
        surface_pub_ = this->create_publisher<vio_health_monitor::msg::SurfaceInfo>("/surface_info", 10);
    }
...
private:
    ...
    rclcpp::Publisher<vio_health_monitor::msg::SurfaceInfo>::SharedPtr surface_pub_;
    ...
    void depth_callback(const sensor_msgs::msg::Image::SharedPtr msg) {
        try {
            ...
            // Publish message
            vio_health_monitor::msg::SurfaceInfo surface_msg;
