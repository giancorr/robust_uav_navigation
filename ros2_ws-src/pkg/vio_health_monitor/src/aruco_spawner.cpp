    ...
    ArucoSpawnerNode() : Node("aruco_spawner_node"), is_spawned_(false), current_side_("NONE"),
        ...
        sub_odom_ = this->create_subscription<nav_msgs::msg::Odometry>(
            ...
            [this](const nav_msgs::msg::Odometry::SharedPtr msg) {
                // Gazebo GT is already in ENU frame
        ...
        // ORA ASCOLTIAMO UNA STRINGA! ("LEFT", "RIGHT", oppure "STOP")
...
private:
    void spawn_paint_stroke() {
        ...
        std::string template_path = "/root/ros2_ws/src/pkg/vio_health_monitor/models/aruco_rescue/model.sdf";
