...
def generate_launch_description():
    ...
    goal_positions = [
        ...
        {"name": "exp00", "x": 2.0, "y": 2.0, "z": 1.5},   # Center front
        {"name": "exp01", "x": 10.0, "y": 5.0, "z": 1.5},   # Right front
        {"name": "exp10", "x": 10.0, "y": 7.0, "z": 1.5},  # Left front
        {"name": "exp11", "x": 2.0, "y": 7.0, "z": 1.5},   # Far right center
